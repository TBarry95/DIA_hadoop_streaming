...
# DES: Script sends all files needed for analysis onto Ubuntu EC" instance where the HDFS is installed.
...
with pysftp.Connection(host=my_hostname, username=my_username, password=my_password, cnopts=cnopts, private_key=private_key_pem) as sftp:
    ...
    local_path_mapper1 = "/home/tiernan/PycharmProjects/DIA/mapper_media_tweets.py"
    local_path_mapper2 = "/home/tiernan/PycharmProjects/DIA/mapper_media_account.py"
    # ---- Reducers: Date and Account:
    local_path_reducer1 = "/home/tiernan/PycharmProjects/DIA/reducer_stats_sent_date.py"
    local_path_reducer2 = "/home/tiernan/PycharmProjects/DIA/reducer_stats_sent_account.py"
